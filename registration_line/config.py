...
class RelativeDrawingConfig(DrawingConfig):
    ...
    :param color: The color of the line in BGR format with alpha channel
    :param width: The width of the line
    :param label: The label to be placed at the end of the line
    :param label_offset: The offset to move the label from the end point
    :param label_font: The font of the labels
    :param label_width: The width of the label text
    ...
    """
    def __init__(
        self, color: Tuple[int, int, int, int], width: int, label: Optional[str],
        label_offset: Optional[Tuple[int, int]], label_font: int, label_width: int, start_point_percentage: int,
        length_percentage: int
    ):
        super().__init__(color, width, None, None, label, label_offset, label_font, label_width)
